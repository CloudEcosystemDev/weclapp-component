 ...
 *
 * Generated at: 2022-02-04T13:59:16.803Z
 ...
 *
 * Operation: undefined
 * Endpoint Path: '/productionOrder/id/{id}/downloadLatestProductionOrderPdf'
 * Method: 'get'
 *
 */
...
function processTrigger(msg, cfg, snapshot = {}) {
  ...
  let callParams = {
    ...
    pathName: '/productionOrder/id/{id}/downloadLatestProductionOrderPdf',
    method: 'get',
    ...
    if (Array.isArray(newElement.data)) {
      ...
      for (let i = 0; i < newElement.data.length; i++) {
        ...
        const currentObjectDate = newObject.data[snapshotKey]
          ...
          : newObject.data['lastModifiedDate'];
        if (snapshot.lastUpdated === 0) {
          if (isSecondDateAfter(currentObjectDate, lastElement)) {
            lastElement = snapshotKey
              ...
              : newElement.data['lastModifiedDate'];
          }
